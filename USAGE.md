...
The graph view and the library both link here: the graph's sidebar carries **Ask Ripple** under Open the script, so a question about what you are looking at is one click away.
